#ifndef __C_GUI_DECENTRALISED_BUTTON_H_INCLUDED__
#define __C_GUI_DECENTRALISED_BUTTON_H_INCLUDED__
...
namespace irr
{
	namespace gui
	{
		...
		public:
			...
			//! constructor
			CGUIDecentralisedButton(IGUIEnvironment* environment, IGUIElement* parent,
				s32 id, core::rect<s32> rectangle);

			//! destructor
			virtual ~CGUIDecentralisedButton();
			...
			*/
			...
			virtual void setAutoSize(bool isAutoSize = true);

			virtual void setAutoExpand(bool isRight = true);
			...
			virtual void setImages(video::ITexture* left = 0, video::ITexture* middle = 0, video::ITexture* right = 0,
								   video::ITexture* pleft = 0, video::ITexture* pmiddle = 0, video::ITexture* pright = 0);
		...
		private:
			...
			video::ITexture* BackLeft;
			video::ITexture* BackMiddle;
			video::ITexture* BackRight;

			video::ITexture* PressedLeft;
			video::ITexture* PressedMiddle;
			video::ITexture* PressedRight;
