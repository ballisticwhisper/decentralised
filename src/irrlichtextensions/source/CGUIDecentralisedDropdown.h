#ifndef __C_GUI_DECENTRALISED_DROPDOWN_H_INCLUDED__
#define __C_GUI_DECENTRALISED_DROPDOWN_H_INCLUDED__
...
namespace gui
{
	...
	class CGUIDecentralisedDropdown : public IGUIComboBox
	{
	public:

		//! constructor
		CGUIDecentralisedDropdown(IGUIEnvironment* environment, IGUIElement* parent,
