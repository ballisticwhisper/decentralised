...
CGUIDecentralisedMenuBar::CGUIDecentralisedMenuBar(IGUIEnvironment* environment, IGUIElement* parent, s32 id, core::rect<s32> rectangle)
	: CGUIDecentralisedContextMenu(environment, parent, id, rectangle)
{
	Type = EGUIET_MENU;
...
CGUIDecentralisedMenuBar::~CGUIDecentralisedMenuBar()
{

}

void CGUIDecentralisedMenuBar::draw()
{
	if (!IsVisible)
		return;
...
bool CGUIDecentralisedMenuBar::OnEvent(const SEvent& event)
{
	if (isEnabled())
	{
...
void CGUIDecentralisedMenuBar::recalculateSize()
{
...
core::rect<s32> CGUIDecentralisedMenuBar::getHRect(const SItem& i, const core::rect<s32>& absolute) const
{
...
core::rect<s32> CGUIDecentralisedMenuBar::getRect(const SItem& i, const core::rect<s32>& absolute) const
{
	return getHRect(i, absolute);
}


void CGUIDecentralisedMenuBar::updateAbsolutePosition()
{
	if (Parent)
