#ifndef __C_GUI_DECENTRALISED_CONTEXT_MENU_H_INCLUDED__
#define __C_GUI_DECENTRALISED_CONTEXT_MENU_H_INCLUDED__
...
namespace irr
{
	namespace gui
	{
		class CGUIDecentralisedContextMenu : public IGUIContextMenu
		{
		public:

			CGUIDecentralisedContextMenu(IGUIEnvironment* environment,
				IGUIElement* parent, s32 id, core::rect<s32> rectangle,
				bool getFocus = true, bool allowFocus = true);

			virtual ~CGUIDecentralisedContextMenu();
			...
			virtual void setSubMenu(u32 index, CGUIDecentralisedContextMenu* menu);
		...
		protected:
			...
			struct SItem
			{
				...
				s32 PosY;
				CGUIDecentralisedContextMenu* SubMenu;
				s32 CommandId;
			};
