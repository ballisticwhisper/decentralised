...
//			switch (id)
//			{
//			case EMenuItems::ExitApplication:
//				this->Context.Device->closeDevice();
//				break;
//			case EMenuItems::Wiki:
//#ifdef _IRR_WINDOWS_
//				ShellExecute(0, 0, "http://decentralised-project.org/wiki", 0, 0, SW_SHOW);
//#endif
//				break;
//			case EMenuItems::ReportBug:
//#ifdef _IRR_WINDOWS_
//				ShellExecute(0, 0, "http://decentralised-project.org/bug-report", 0, 0, SW_SHOW);
//#endif
//				break;
//			case EMenuItems::AboutApplication:
//				this->Context.GuiManager->ShowWindowAbout();
//				break;
//			default:
//				this->Context.GuiManager->AddConsoleLine(video::SColor(255, 255, 255, 255), std::wstring(item->getItemText(item->getSelectedItem())));
//				break;
//			}
		}
		return false;
