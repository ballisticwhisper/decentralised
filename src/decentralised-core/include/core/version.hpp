#ifndef DC_CORE_VERSION_HPP
#define DC_CORE_VERSION_HPP
...
// DC_CORE_LIB_VERSION is defined to be the same as LIBBITCOIN_VERSION
...
#define DC_CORE_LIB_VERSION "1.0.0"
