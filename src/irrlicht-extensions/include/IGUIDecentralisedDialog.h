#ifndef __I_GUI_DECENTRALISED_DIALOG_H_INCLUDED__
#define __I_GUI_DECENTRALISED_DIALOG_H_INCLUDED__
...
namespace gui
{
	...
	*/
	class IGUIDecentralisedDialog : public IGUIElement
	{
	public:

		//! constructor
		IGUIDecentralisedDialog(IGUIEnvironment* environment, IGUIElement* parent, s32 id, core::rect<s32> rectangle, bool hasTitleBar = true)
		...
		virtual void setDialogSkin(irr::video::ITexture *background, irr::video::ITexture *foreground) = 0;
	};
